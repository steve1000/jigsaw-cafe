 ...
 */
const horizonalSide = (sx, sy, ex, ey, type, shape, direction, pieceWidth, pieceHeight, straight = false) => {
 ...
 */
function verticalSide(sx, sy, ex, ey, type, threeShape, direction, pieceWidth, pieceHeight, straight = false) {
    let shape = threeShape || new THREE.Shape();
    const width = pieceWidth
    const height = pieceHeight
...
const generateBoard = ({ image, canvas, rowLength, columnLength }) => {
